@component('layouts.app', [
    ...
    @if (now() < \Illuminate\Support\Facades\Date::create('2023-06-15 00:00:00'))
        <section class="wrapper markup pb-4 md:pb-16">
            <div class="md:w-2/3">
                <h1>Contact</h1>
                <p class="text-xl">Take a look at <a href="https://fullstackeurope.com">Full Stack Europe</a> to contact us.</p>
            </div>
        </section>
    @else
        <section class="wrapper markup pb-4 md:pb-16">
                ...
                <div class="md:flex items-start mb-8 md:mb-12">
                    ...
                    <div class="markup flex-1 md:mt-1">
                        ...
                        <ul>
                            ...
                            <li class="mb-2">Your message of choice in a monthly newsletter sent to the full member list of one of our user groups (> 1000 members, max two paragaphs)</li>
                        </ul>
